...
Or see [Manual Installation](./manual-installation) for the complete file structure and code.
...
- **Manual Installation** - See [complete file structure](./manual-installation)
- **Examples** - Check out more advanced usage patterns in the API docs

## Need Help?

- Review the [OSLC Introduction](./what-is-oslc) for background
- Check the [IBM Jazz & ELM guide](./ibm-jazz-elm) for Jazz-specific details
