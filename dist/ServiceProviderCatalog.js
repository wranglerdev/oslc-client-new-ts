...
export default class ServiceProviderCatalog extends OSLCResource {
    ...
    serviceProvider(serviceProviderTitle) {
        const sp = this.store.statementsMatching(undefined, dcterms('title'), $rdf.literal(serviceProviderTitle, this.store.sym('http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral')));
        if (!sp || sp.length === 0) {
            return undefined;
        }
        else {
...
//# sourceMappingURL=ServiceProviderCatalog.js.map